# 03 — Province Data 国のデータ (戦略モード, pp. 18–19)

Source: scan 11. Province data is shown when selecting a city/province in
Strategy Mode. Despite the Japanese label 国のデータ, the panel shows the
statistics of a single **province** (a country contains one or more
provinces); see the note in [terminology.md](terminology.md).
Example panel (并州): 金 5066, 米 8006(?), 土地 427(?),
...
|----------|---------|-------------------|
| 統治度 | Touchido | Governance/control. Low values cause unrest and rebellion; high values stabilize the province |
...
| 武将 | Bushou | Number of generals stationed (up to 10 per province) |
