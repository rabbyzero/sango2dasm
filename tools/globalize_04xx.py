...
CANONICAL = {
    ...
    0x04B0: ("state_04b0",           ""),
    0x04B1: ("war_side_strength_0",  "Side war-strength gauge, side 0 (1-byte [0,100], seeded from commander Vitality, not TroopCount)"),
    0x04B2: ("war_side_strength_1",  "Side war-strength gauge, side 1"),
