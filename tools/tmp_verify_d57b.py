#!/usr/bin/env python3
"""Region verification for $A000-$D739 of prg_08_09.asm (through
BattleMapScrollUpdate, BattleResultSceneInit, BattleSlotClear and
BattleResultDispatch). Slices the bank file through the routines, forces
absolute $00xx operands, assembles, links (both CODE_BANK08 and
...
"""
open("build/_region_d57b.cfg", "w").write(CFG)
...
r = subprocess.run([LD65, "-C", "build/_region_d57b.cfg", "build/_region.o",
...
total = 0x2000 + n9
print(f"compared {total} bytes ($A000-$BFFF, $C000-$D739), {mismatch} mismatches"
