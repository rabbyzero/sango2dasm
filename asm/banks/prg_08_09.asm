...
;===============================================================================
.proc AiTurnProcess
  LDA $6F8B                             ; $A02D: AD 8B 6F  ; game start flag
  CMP #$FF                              ; $A030: C9 FF
...
@OfficerLoop:
  LDY $6F94                             ; $A03C: AC 94 6F  ; officer scan index
  CPY #$14                              ; $A03F: C0 14     ; max 20 officers
  BCS @CountCheck                       ; $A041: B0 30
  INC $6F94                             ; $A043: EE 94 6F
  LDA $6FA1,Y                           ; $A046: B9 A1 6F  ; officer state table
  CMP #$FF                              ; $A049: C9 FF
@SkipCheck:
  BEQ @LoopContinue                     ; $A04B: F0 1F
  JSR AiCheckFaction                    ; $A04D: 20 44 A9  ; check faction
  BMI @LoopContinue                     ; $A050: 30 1A
  LDA $0664,Y                           ; $A052: B9 64 06  ; officer record ptr
  CMP #$FF                              ; $A055: C9 FF
  BEQ @LoopContinue                     ; $A057: F0 13
  INC $6F96                             ; $A059: EE 96 6F  ; valid officer count
  STY $6F8C                             ; $A05C: 8C 8C 6F  ; current officer index
  JSR @AiOfficerActionDecide            ; $A05F: 20 99 A0
  LDA $6F8F                             ; $A062: AD 8F 6F  ; action result
  CMP #$03                              ; $A065: C9 03     ; 3 = no action
  BNE @Done                             ; $A067: D0 2A
  INC $6F95                             ; $A069: EE 95 6F  ; acted count
@LoopContinue:
  LDA $6F94                             ; $A06C: AD 94 6F
  CMP #$14                              ; $A06F: C9 14
  BCC @OfficerLoop                      ; $A071: 90 C9
@CountCheck:
  LDA $6F96                             ; $A073: AD 96 6F  ; valid count
  CMP $6F95                             ; $A076: CD 95 6F  ; acted count
...
@Done:
  LDA #$FF                              ; $A093: A9 FF
  STA $6F8B                             ; $A095: 8D 8B 6F  ; mark turn complete
  RTS                                   ; $A098: 60
;===============================================================================
...
@AiOfficerActionDecide:
  LDA $6FA1,Y                           ; $A099: B9 A1 6F  ; officer state
...
Action_DefaultDecision:
  LDA $0504                             ; $A0B1: AD 04 05  ; AI faction flag
...
@RandomAction:
  ...
  RTS                                   ; $A0DD: 60
@MoveToCity:
  LDA $0600                             ; $A0DE: AD 00 06  ; capital city X
  STA $0020                             ; $A0E1: 8D 20 00
  LDA $0614                             ; $A0E4: AD 14 06  ; capital city Y
...
@TryRecruit:
  ...
  RTS                                   ; $A110: 60
@CheckStrength:
  LDA $0505                             ; $A111: AD 05 05  ; move points/strength
  CMP #$02                              ; $A114: C9 02
...
@ScanAdjLoop:
  ...
  LDY #$00                              ; $A12A: A0 00
@ScanAdjNext:
  LDA $6FDD,Y                           ; $A12C: B9 DD 6F  ; adjacent officer entry
  AND #$7F                              ; $A12F: 29 7F     ; strip enemy bit
  CMP $0020                             ; $A131: CD 20 00
  BNE @ScanAdjNext2                     ; $A134: D0 09
  STA $6F8D                             ; $A136: 8D 8D 6F  ; target found
  LDA #$01                              ; $A139: A9 01
  STA $6F8F                             ; $A13B: 8D 8F 6F  ; result = attack target
  RTS                                   ; $A13E: 60
@ScanAdjNext2:
  INY                                   ; $A13F: C8
  CPY #$04                              ; $A140: C0 04
...
@MarchToCapital:
  ...
  LDA $0600,X                           ; $A14B: BD 00 06  ; capital X
  STA $0020                             ; $A14E: 8D 20 00
  LDA $0614,X                           ; $A151: BD 14 06  ; capital Y
  CMP #$10                              ; $A154: C9 10
...
@ScanEnemyLoop:
  ...
  LDA $0600,Y                           ; $A1AB: B9 00 06  ; enemy X
  STA $0020                             ; $A1AE: 8D 20 00
  LDA $0614,Y                           ; $A1B1: B9 14 06  ; enemy Y
  CMP #$10                              ; $A1B4: C9 10
...
GetOrderedDestination:
  ...
  JSR $F266                             ; $A1E7: 20 66 F2  ; SwitchBank8_A
  LDA $050E                             ; $A1EA: AD 0E 05  ; province/action index
...
@DefScanLoop:
  ...
  STY $6F8E                             ; $A256: 8C 8E 6F  ; remember target officer
  JSR AiScanAdjacentOfficers            ; $A259: 20 37 A8  ; fill $6FDD
  LDY #$00                              ; $A25C: A0 00
@DefAdjCheck:
  LDA $6FDD,Y                           ; $A25E: B9 DD 6F  ; adjacent officer
...
@DefAdjNext:
  ...
  LDY $6F8E                             ; $A271: AC 8E 6F  ; target officer
...
@SwScanLoop:
  ...
  STY $6F8E                             ; $A2ED: 8C 8E 6F  ; remember target officer
...
Action_CaptureProvince:
  ...
  JSR $F266                             ; $A32B: 20 66 F2  ; SwitchBank8_A
  LDA $050E                             ; $A32E: AD 0E 05  ; province index
...
@CapApplyStep:
  ...
  JSR $F266                             ; $A38C: 20 66 F2  ; SwitchBank8_A
...
@CapArrived:
  ...
  LDA $6FA1,Y                           ; $A3B1: B9 A1 6F  ; officer state
  AND #$F0                              ; $A3B4: 29 F0
...
@CapGetPtr:
  LDA $0526,X                           ; $A3C4: BD 26 05  ; province value lo
  STA $0020                             ; $A3C7: 8D 20 00
  LDA $0527,X                           ; $A3CA: BD 27 05  ; province value hi
...
@CapCalcDelta:
  ...
  JSR $F266                             ; $A44E: 20 66 F2  ; SwitchBank8_A
...
@CapCheckFunds:
  ...
  LDA $0526,X                           ; $A480: BD 26 05  ; province value lo
  SEC                                   ; $A483: 38
  ...
  LDA $0522,X                           ; $A493: BD 22 05  ; stock lo
  CLC                                   ; $A496: 18
...
@CapPartial:
  ...
  LDA $0526,X                           ; $A4E0: BD 26 05  ; province value lo
  SEC                                   ; $A4E3: 38
...
Action_RestoreHP:
  ...
  JSR $F266                             ; $A509: 20 66 F2  ; SwitchBank8_A
  LDA $050E                             ; $A50C: AD 0E 05  ; province index
...
@HealStoreY:
  ...
  LDA $0600,Y                           ; $A53D: B9 00 06  ; officer X
  STA $0020                             ; $A540: 8D 20 00
  LDA $0614,Y                           ; $A543: B9 14 06  ; officer Y
  STA $0021                             ; $A546: 8D 21 00
  LDY #$00                              ; $A549: A0 00     ; adjust X by default
  LDA $6F8D                             ; $A54B: AD 8D 6F  ; move result flags
  AND #$02                              ; $A54E: 29 02
...
@HealApplyStep:
  ...
  JSR $F266                             ; $A570: 20 66 F2  ; SwitchBank8_A
...
@HealArrived:
  ...
  LDA $6FA1,Y                           ; $A598: B9 A1 6F  ; officer state
  AND #$F0                              ; $A59B: 29 F0
...
@HealCheckGold:
  LDA $0527,X                           ; $A5AB: BD 27 05  ; gold hi
  BNE @HealDeductGold                   ; $A5AE: D0 08     ; >= $100: affordable
  LDA $0526,X                           ; $A5B0: BD 26 05  ; gold lo
...
@HealRollLoop:
  ...
  LDA $0664,Y                           ; $A5DB: B9 64 06  ; officer record id
...
@AbsX:
  ...
  LDA $0614,Y                           ; $A629: B9 14 06  ; officer Y
  CMP #$10                              ; $A62C: C9 10
...
@BestCandidateReady:
  ...
  LDA $6FB5,Y                           ; $A6CA: B9 B5 6F  ; prev reverse direction
...
@CandidateLoop:
  ...
  TAX                                   ; $A6DE: AA
  LDA $6FDD,X                           ; $A6DF: BD DD 6F  ; adjacent scan result
  CMP #$FF                              ; $A6E2: C9 FF
...
@TryNextCandidate:
  ...
  LDA $6FA1,Y                           ; $A6EE: B9 A1 6F  ; officer state
...
@CommitMove:
  ...
  LDA $0650,Y                           ; $A705: B9 50 06  ; immobilized flag
  BNE @AbortNoAction                    ; $A708: D0 EF
  STX $6F8D                             ; $A70A: 8E 8D 6F  ; chosen direction
  ...
  LDA $6F8D                             ; $A71F: AD 8D 6F  ; chosen direction
  EOR #$01                              ; $A722: 49 01     ; reverse dir (N<->S, W<->E)
  STA $6FB5,Y                           ; $A724: 99 B5 6F  ; store reverse of this move
  RTS                                   ; $A727: 60
...
@ApplyStepVector:
  ...
  LDA $0600,X                           ; $A767: BD 00 06  ; officer X
  CLC                                   ; $A76A: 18
...
@StepBlocked:
  ...
  RTS                                   ; $A778: 60
@CheckYBounds:
  LDA $0614,X                           ; $A779: BD 14 06  ; officer Y
  CLC                                   ; $A77C: 18
  ...
  LDA $0664,Y                           ; $A790: B9 64 06  ; officer id
...
@EncounterLoop:
  ...
  LDA $6FDD,X                           ; $A811: BD DD 6F  ; adjacent scan result
...
AiScanAdjacentOfficers:
  LDA $0600,Y                           ; $A837: B9 00 06  ; officer X
  STA $0022                             ; $A83A: 8D 22 00
  LDA $0614,Y                           ; $A83D: B9 14 06  ; officer Y
  CMP #$10                              ; $A840: C9 10
...
@ScanPosition:
  LDY #$00                              ; $A871: A0 00
@Loop:
  LDA $0664,Y                           ; $A873: B9 64 06  ; officer record
  CMP #$FF                              ; $A876: C9 FF
  BEQ @NotFound                         ; $A878: F0 23
  LDA $0600,Y                           ; $A87A: B9 00 06  ; officer X
  CMP $0022                             ; $A87D: CD 22 00  ; target X
  BNE @NotFound                         ; $A880: D0 1B
  LDA $0614,Y                           ; $A882: B9 14 06  ; officer Y
  CMP #$10                              ; $A885: C9 10
...
@CompareY:
  ...
  STA $6FDD,X                           ; $A899: 9D DD 6F  ; store result
  RTS                                   ; $A89C: 60
@NotFound:
  INY                                   ; $A89D: C8
  CPY #$14                              ; $A89E: C0 14
...
AiFindNearbyOfficers:
  ...
  LDA $0600,Y                           ; $A8D6: B9 00 06  ; reference officer X
  STA $0020                             ; $A8D9: 8D 20 00
  LDA $0614,Y                           ; $A8DC: B9 14 06  ; reference officer Y
  CMP #$10                              ; $A8DF: C9 10
...
@ScanSlot:
  LDA #$00                              ; $A8EA: A9 00
  STA $6FC9,Y                           ; $A8EC: 99 C9 6F  ; clear entry
  LDA $0664,Y                           ; $A8EF: B9 64 06  ; officer status
  CMP #$FF                              ; $A8F2: C9 FF
  BEQ @NextSlot                         ; $A8F4: F0 48     ; inactive slot
  LDA $0600,Y                           ; $A8F6: B9 00 06  ; candidate X
  SEC                                   ; $A8F9: 38
...
@DxOk:
  ...
  LDA $0614,Y                           ; $A911: B9 14 06  ; candidate Y
  CMP #$10                              ; $A914: C9 10
...
;===============================================================================
AiCheckMove:
  LDY $6F8C                             ; $A95C: AC 8C 6F  ; current AI officer
...
@StoreTier:
  ...
  LDY #$00                              ; $A991: A0 00
@TryCandidate:
  LDA $6FC9,Y                           ; $A993: B9 C9 6F  ; candidate officer slot
  CMP #$FF                              ; $A996: C9 FF
  ...
  STA $6F8E                             ; $A9B6: 8D 8E 6F  ; action target officer
  LDA #$02                              ; $A9B9: A9 02
  STA $6F8F                             ; $A9BB: 8D 8F 6F  ; decision = act on target
  SEC                                   ; $A9BE: 38
  RTS                                   ; $A9BF: 60
@Retry:
...
@NoCandidate:
  LDA #$03                              ; $A9C8: A9 03
  STA $6F8F                             ; $A9CA: 8D 8F 6F  ; decision = nothing feasible
  CLC                                   ; $A9CD: 18
  RTS                                   ; $A9CE: 60
;===============================================================================
...
@RandomAction2:
  ...
  LDA $0650,Y                           ; $AAA1: B9 50 06  ; candidate state
  AND #$0F                              ; $AAA4: 29 0F
...
@NoAction:
  LDA #$03                              ; $AAF1: A9 03
  STA $6F8F                             ; $AAF3: 8D 8F 6F  ; decision = nothing feasible
  CLC                                   ; $AAF6: 18
  RTS                                   ; $AAF7: 60
;===============================================================================
...
;===============================================================================
AiCheckRecruit:
  LDY $6F8C                             ; $AAF8: AC 8C 6F  ; current AI officer
...
@ScanCandidates:
  ...
  LDY #$00                              ; $AB2A: A0 00
@TryCandidate:
  LDA $6FC9,Y                           ; $AB2C: B9 C9 6F  ; candidate officer slot
  CMP #$FF                              ; $AB2F: C9 FF
  ...
  STA $6F8E                             ; $AB4F: 8D 8E 6F  ; recruit target officer
  LDA #$02                              ; $AB52: A9 02
  STA $6F8F                             ; $AB54: 8D 8F 6F  ; decision = act on target
  SEC                                   ; $AB57: 38
  RTS                                   ; $AB58: 60
@Retry:
...
@NoCandidate:
  LDA #$03                              ; $AB61: A9 03
  STA $6F8F                             ; $AB63: 8D 8F 6F  ; decision = nothing feasible
  CLC                                   ; $AB66: 18
  RTS                                   ; $AB67: 60
; ---------------------------------------------------------------------------
...
; ---             budget >= 9 ---
  ...
  LDA $0650,X                           ; $AB77: BD 50 06  ; candidate state
  AND #$0F                              ; $AB7A: 29 0F
...
AiCheckActionFeasible:
  ...
  LDA $0600,Y                           ; $AC81: B9 00 06  ; target map X
  STA $0020                             ; $AC84: 8D 20 00
  LDA $0614,Y                           ; $AC87: B9 14 06  ; target map Y
  STA $0021                             ; $AC8A: 8D 21 00
  JSR GetTileTerrainClamped             ; $AC8D: 20 E5 B6  ; terrain at target
  STA $0028                             ; $AC90: 8D 28 00
  LDY $6F8C                             ; $AC93: AC 8C 6F  ; current officer
  LDA $0600,Y                           ; $AC96: B9 00 06  ; self map X
  STA $0020                             ; $AC99: 8D 20 00
  LDA $0614,Y                           ; $AC9C: B9 14 06  ; self map Y
...
AiFeasible_AmbushAllSides:
  ...
  BNE @Fail                             ; $ADD2: D0 26
  LDY $6F8C                             ; $ADD4: AC 8C 6F
  LDA $0664,Y                           ; $ADD7: B9 64 06
...
@CheckSlot:
  LDY #$00                              ; $ADEA: A0 00
  LDA $0504                             ; $ADEC: AD 04 05  ; acting-side flag
...
AiSortNearbyOfficers:
  ...
  LDY #$00                              ; $AE95: A0 00
@FilterLoop:
  LDA $6FC9,Y                           ; $AE97: B9 C9 6F  ; entry: bit7|distance
  STA $0020                             ; $AE9A: 8D 20 00
  LDA #$FF                              ; $AE9D: A9 FF
  STA $6FC9,Y                           ; $AE9F: 99 C9 6F  ; clear entry
  LDA $0020                             ; $AEA2: AD 20 00
  BPL @FilterNext                       ; $AEA5: 10 05     ; ally/empty -> skip
  TYA                                   ; $AEA7: 98
  STA $6FC9,X                           ; $AEA8: 9D C9 6F  ; keep enemy slot index
  INX                                   ; $AEAB: E8
@FilterNext:
  INY                                   ; $AEAC: C8
...
@SortPass:
  LDX #$00                              ; $AEBA: A2 00
@ComparePair:
  LDA $6FC9,X                           ; $AEBC: BD C9 6F  ; slot of element X
  TAY                                   ; $AEBF: A8
  ...
  LDA $6FCA,X                           ; $AED3: BD CA 6F  ; slot of element X+1
  TAY                                   ; $AED6: A8
...
;===============================================================================
AiCheckFlee:
  LDA $0507                             ; $AF0D: AD 07 05  ; side/province packed byte
  LDX $0504                             ; $AF10: AE 04 05  ; acting-side flag
...
@MaskProvince:
  ...
  LDA $0664,Y                           ; $AF28: B9 64 06  ; officer home value
...
; ---------------------------------------------------------------------------
@FindDest:
  LDA $0504                             ; $AFF6: AD 04 05  ; acting-side flag
  BPL @ScanCandidates                   ; $AFF9: 10 07
  LDA $052A                             ; $AFFB: AD 2A 05  ; AI preset retreat target
...
@ScanCandidates:
  ...
  LDY #$30                              ; $B00A: A0 30
  JSR $F266                             ; $B00C: 20 66 F2  ; SwitchBank8_A: bank $30
  LDA $050E                             ; $B00F: AD 0E 05  ; turn/phase index
  ASL                                   ; $B012: 0A
  ASL                                   ; $B013: 0A
  ASL                                   ; $B014: 0A        ; *8
...
@FoundDest:
  ...
  STA $6F8D                             ; $B063: 8D 8D 6F  ; owned, ungarrisoned province
  RTS                                   ; $B066: 60
;===============================================================================
...
@OfficerLoop:
  LDA $0664,Y                           ; $B075: B9 64 06  ; officer home value
  CMP #$FF                              ; $B078: C9 FF
...
AiComputeBattleStats:
  LDA #$1E                              ; $B0B8: A9 1E
  SEC                                   ; $B0BA: 38
  SBC $0506                             ; $B0BB: ED 06 05  ; day of month
...
.proc BattleSetup
  ...
  LDA #$FF                              ; $B132: A9 FF
@ClearOfficerStates:
  STA $6FA1,Y                           ; $B134: 99 A1 6F  ; officer state table
  INY                                   ; $B137: C8
  CPY #$40                              ; $B138: C0 40
  ...
  LDA #$00                              ; $B13E: A9 00
@ClearProximityTable:
  STA $6FC9,Y                           ; $B140: 99 C9 6F  ; proximity scan table
  INY                                   ; $B143: C8
  CPY #$14                              ; $B144: C0 14
  BCC @ClearProximityTable              ; $B146: 90 F8
  LDA $0507                             ; $B148: AD 07 05  ; battle faction pair
  ...
  LDA #$00                              ; $B15B: A9 00
  STA $6F91                             ; $B15D: 8D 91 6F  ; side 0 unit index base
  STA $6FA1                             ; $B160: 8D A1 6F  ; first queue entry = 0
...
@CheckAttacker:
  ...
  LDA #$0A                              ; $B183: A9 0A
  STA $6F91                             ; $B185: 8D 91 6F  ; side 1 unit index base (10)
  LDA #$00                              ; $B188: A9 00
  STA $6FAB                             ; $B18A: 8D AB 6F  ; first queue entry = 0
...
@ClearArmySlots:
  ...
  LDA #$FF                              ; $B19A: A9 FF
@FillArmySlots:
  STA $04D8,Y                           ; $B19C: 99 D8 04  ; army_slot_base
  INY                                   ; $B19F: C8
  CPY #$08                              ; $B1A0: C0 08
  BCC @FillArmySlots                    ; $B1A2: 90 F8
  LDA #$00                              ; $B1A4: A9 00
  STA $6F94                             ; $B1A6: 8D 94 6F  ; officer scan index
  STA $6F95                             ; $B1A9: 8D 95 6F  ; acted officer count
  STA $6F96                             ; $B1AC: 8D 96 6F  ; valid officer count
  RTS                                   ; $B1AF: 60
;-------------------------------------------------------------------------------
...
@AddRowOffset:
  ...
  LDA $6F94                             ; $B1D6: AD 94 6F  ; unit count - 1
...
@ExpandInit:
  ...
  LDY $6F91                             ; $B234: AC 91 6F  ; queue write index
  INY                                   ; $B237: C8        ; skip head entry
@ExpandLoop:
  LDA $6F99,X                           ; $B238: BD 99 6F  ; units for this slot
  BEQ @NextSlot                         ; $B23B: F0 12
  STA $0021                             ; $B23D: 8D 21 00
@FillUnit:
  LDA $0020                             ; $B240: AD 20 00
  STA $6FA1,Y                           ; $B243: 99 A1 6F  ; placement queue entry
  INY                                   ; $B246: C8
...
@StoreCoordinates:
  LDX $6F91                             ; $B266: AE 91 6F  ; side unit base
  TXA                                   ; $B269: 8A
  CLC                                   ; $B26A: 18
  ...
  INX                                   ; $B27D: E8
@CoordLoop:
  LDA $6FA1,X                           ; $B27E: BD A1 6F  ; placement queue entry
  CMP #$FF                              ; $B281: C9 FF
...
@SetupDefenderRoster:
  LDY #$30                              ; $B2AE: A0 30
  JSR $F266                             ; $B2B0: 20 66 F2  ; SwitchBank8_A: bank $30
  LDA $050E                             ; $B2B3: AD 0E 05  ; province group index
  ASL                                   ; $B2B6: 0A
  ASL                                   ; $B2B7: 0A
  ASL                                   ; $B2B8: 0A        ; *8
  TAY                                   ; $B2B9: A8
...
@CompareProvince:
  CMP $052A                             ; $B2C4: CD 2A 05  ; current province
...
@GotProvince:
  ...
  PHA                                   ; $B2CE: 48
  LDY #$31                              ; $B2CF: A0 31
  JSR $F266                             ; $B2D1: 20 66 F2  ; bank $31
  PLA                                   ; $B2D4: 68
  TAY                                   ; $B2D5: A8
...
@ScaleDescriptor:
  ...
  LDY #$26                              ; $B2E4: A0 26
  JSR $F266                             ; $B2E6: 20 66 F2  ; bank $26
...
@SetupAttackerRoster:
  LDY #$30                              ; $B312: A0 30
  JSR $F266                             ; $B314: 20 66 F2  ; SwitchBank8_A: bank $30
  LDA $050E                             ; $B317: AD 0E 05  ; province group index
  ASL                                   ; $B31A: 0A
  ASL                                   ; $B31B: 0A
  ASL                                   ; $B31C: 0A        ; *8
  TAY                                   ; $B31D: A8
...
@CompareProvinceAtk:
  CMP $052A                             ; $B328: CD 2A 05  ; current province
...
@ScaleDescriptorAtk:
  ...
  LDY #$26                              ; $B343: A0 26
  JSR $F266                             ; $B345: 20 66 F2  ; bank $26
...
;-------------------------------------------------------------------------------
@CountAndSortUnits:
  LDA $6F91                             ; $B371: AD 91 6F  ; side unit base
  TAY                                   ; $B374: A8
  CLC                                   ; $B375: 18
...
@CountLoop:
  LDA $0664,Y                           ; $B37D: B9 64 06  ; officer id
  CMP #$FF                              ; $B380: C9 FF
...
FactionRecordPtrTable:                  ; faction 0-6 records, 8 bytes apart
  .word $6F07,$6F0F,$6F17,$6F1F,$6F27,$6F2F,$6F37 ; $B4D3: 07 6F 0F 6F 17 6F 1F 6F 27 6F 2F 6F 37 6F
...
; --- Code Region ---
  LDY #$31                              ; $B4E1: A0 31
  JSR $F266                             ; $B4E3: 20 66 F2  ; SwitchBank8_A
  LDY #$00                              ; $B4E6: A0 00
...
@LoadZone:
  ...
  TAY                                   ; $B71B: A8
  JSR $F266                             ; $B71C: 20 66 F2  ; SwitchBank8_A
...
.proc BattleResultProcess
  LDA #$FF                              ; $B933: A9 FF
  STA $6F8F                             ; $B935: 8D 8F 6F  ; action result = none
  LDY #$04                              ; $B938: A0 04     ; army slot base (side 1)
  LDA $0504                             ; $B93A: AD 04 05  ; AI faction flag
  BPL @SlotSelected                     ; $B93D: 10 02
  LDY #$00                              ; $B93F: A0 00     ; side 0 slot base
@SlotSelected:
  STY $002A                             ; $B941: 8C 2A 00
  LDA $04D8,Y                           ; $B944: B9 D8 04  ; army_slot_base entry
  CMP #$FF                              ; $B947: C9 FF
  BNE @LoadTargetCoords                 ; $B949: D0 03
  JMP @FinishBattle                     ; $B94B: 4C AD BA     ; no pending strike
@LoadTargetCoords:
  LDA $04D9,Y                           ; $B94E: B9 D9 04  ; target X
  STA $0020                             ; $B951: 8D 20 00
  LDA $04DA,Y                           ; $B954: B9 DA 04  ; target Y
  STA $0021                             ; $B957: 8D 21 00
  LDX $6F8C                             ; $B95A: AE 8C 6F  ; current officer slot
  LDA $0600,X                           ; $B95D: BD 00 06  ; officer X
  CMP $0020                             ; $B960: CD 20 00
  BNE @NormalizeTargetY                 ; $B963: D0 08
  LDA $0614,Y                           ; $B965: B9 14 06  ; note: indexed by slot base Y
...
@RangeScan:
  ...
  JSR $A8E8                             ; $B97F: 20 E8 A8  ; AiFindNearbyOfficers scan loop; ($20,$21) = target
  LDX $6F8C                             ; $B982: AE 8C 6F
  LDA $6FC9,X                           ; $B985: BD C9 6F  ; proximity entry for self
  BNE @ResolveCombat                    ; $B988: D0 03     ; nonzero = in range
  JMP @FinishBattle                     ; $B98A: 4C AD BA
@ResolveCombat:
  LDX $6F8C                             ; $B98D: AE 8C 6F
  LDA $0600,X                           ; $B990: BD 00 06  ; own X
  STA $0020                             ; $B993: 8D 20 00
  LDA $0614,X                           ; $B996: BD 14 06  ; own Y
...
@LoadTargetOfficer:
  ...
  LDA $04D8,Y                           ; $B9A9: B9 D8 04  ; target officer index
  TAX                                   ; $B9AC: AA
  LDA $0664,X                           ; $B9AD: BD 64 06  ; target officer id
  ...
  LDA $0664,Y                           ; $B9C4: B9 64 06  ; own officer id
...
@RollFactor:
  ...
  LDA $0664,Y                           ; $BA48: B9 64 06  ; own officer id
...
@ApplyDamage:
  ...
  STA $042C                             ; $BA9A: 8D 2C 04  ; result: damage low
  LDA $0023                             ; $BA9D: AD 23 00
  STA $042D                             ; $BAA0: 8D 2D 04  ; result: damage high
  LDA #$00                              ; $BAA3: A9 00
  STA $042E                             ; $BAA5: 8D 2E 04  ; result counter
  LDA #$00                              ; $BAA8: A9 00
  STA $6F8F                             ; $BAAA: 8D 8F 6F  ; action result = done
@FinishBattle:
  LDA #$FF                              ; $BAAD: A9 FF
  STA $6F8B                             ; $BAAF: 8D 8B 6F  ; game start flag = resolved
  RTS                                   ; $BAB2: 60
.endproc
;===============================================================================
...
.proc BattlePhaseProcess
  ...
  JSR CallbackDispatcher                ; $BAB6: 20 DE EA
...
.proc BattleAttackerSetup
  ...
  STA $6F44                             ; $BAF5: 8D 44 6F  ; store defender faction
@AttNotAtWar:
  LDA $0514                             ; $BAF8: AD 14 05
  BEQ @AttSkipBattle                    ; $BAFB: F0 12
  LDA #$0A                              ; $BAFD: A9 0A  ; (dead store)
  LDA #$0D                              ; $BAFF: A9 0D
  STA $0500                             ; $BB01: 8D 00 05  ; next state
  LDA #$00                              ; $BB04: A9 00
  STA $0501                             ; $BB06: 8D 01 05  ; reset phase
  LDA #$11                              ; $BB09: A9 11
  STA $050B                             ; $BB0B: 8D 0B 05
  RTS                                   ; $BB0E: 60
@AttSkipBattle:
  LDA #$0E                              ; $BB0F: A9 0E
  STA $0500                             ; $BB11: 8D 00 05  ; next state (alt)
  LDA #$00                              ; $BB14: A9 00
...
@AttAtWar:
  LDA #$80                              ; $BB1F: A9 80
  STA $0504                             ; $BB21: 8D 04 05  ; attacker flag (bit 7 set)
  LDA $0514                             ; $BB24: AD 14 05
  BEQ @AttDefNotWar                     ; $BB27: F0 08
  LDA #$02                              ; $BB29: A9 02
  STA $6F91                             ; $BB2B: 8D 91 6F  ; dispatch index
...
.proc BattleDefenderSetup
  ...
  STA $6F44                             ; $BB4D: 8D 44 6F  ; store attacker faction
...
DoDispatch:
  ...
  JSR CallbackDispatcher                ; $BC49: 20 DE EA
...
@MarkNotAtWar:
  ...
  JSR $E856                             ; $BD41: 20 56 E8  ; random or computed value
  CLC                                   ; $BD44: 18
...
;-------------------------------------------------------------------------------
TurnThresholds:
  .byte $01,$02,$03,$04,$06,$F5,$01,$E8,$03,$B8,$0B,$88,$13,$05,$06,$07; $C015
  .byte $08,$09                           ; $C025
;-------------------------------------------------------------------------------
...
.proc AiOfficerActionDispatch
  LDA $0501                             ; $C0BB: AD 01 05  ; phase index
...
State0_ShowActionPanel:
  ...
  LDA #$00                              ; $C10F: A9 00
  STA $0500                             ; $C111: 8D 00 05  ; clear command id
  STA $0501                             ; $C114: 8D 01 05  ; back to phase 0
@Wait:
  RTS                                   ; $C117: 60
@ExecuteAction:
  LDA #$00                              ; $C118: A9 00
  STA $048B                             ; $C11A: 8D 8B 04  ; clear action work area
  ...
  LDA $050E                             ; $C12E: AD 0E 05  ; action index
  ...
  LDA $0522,X                           ; $C147: BD 22 05  ; direct path: stat A pair
  ...
  STA $042C                             ; $C15A: 8D 2C 04  ; reported amount
  LDA #$00                              ; $C15D: A9 00
  STA $042D                             ; $C15F: 8D 2D 04
  STA $042E                             ; $C162: 8D 2E 04
  LDA #$02                              ; $C165: A9 02
  STA $0501                             ; $C167: 8D 01 05  ; continue in state 2
...
@PercentPath:
  ...
  LDA $0526,X                           ; $C181: BD 26 05  ; stat B pair = base value
...
@RoundDone:
  ...
  STA $0490                             ; $C1CB: 8D 90 04  ; delta = ceil(statB*pct/100)
  LDA $0001                             ; $C1CE: AD 01 00
  ADC #$00                              ; $C1D1: 69 00
  STA $0491                             ; $C1D3: 8D 91 04
  INC $0501                             ; $C1D6: EE 01 05  ; continue in state 1
...
State1_GrowStatA:
  ...
  DEC $0501                             ; $C20A: CE 01 05  ; step back to state 0
  LDA #$00                              ; $C20D: A9 00
  STA $0424                             ; $C20F: 8D 24 04
  STA $0425                             ; $C212: 8D 25 04
  LDA #$A8                              ; $C215: A9 A8     ; UI mode $A8
  JMP B1F_SetUI2                        ; $C217: 4C 83 F2
@Wait:
  RTS                                   ; $C21A: 60
@ApplyGain:
  LDA $048E                             ; $C21B: AD 8E 04  ; delta pair
...
@ScaleToBase:
  ...
  LDA $0526,X                           ; $C261: BD 26 05  ; stat B -= base
  SEC                                   ; $C264: 38
  ...
  LDA #$00                              ; $C273: A9 00
  STA $0526,X                           ; $C275: 9D 26 05  ; clamp at 0
@StatBClampDone:
  STA $0527,X                           ; $C278: 9D 27 05
  LDA $0522,X                           ; $C27B: BD 22 05  ; stat A += delta
  CLC                                   ; $C27E: 18
  ...
  LDA $0522,X                           ; $C28E: BD 22 05  ; clamp at 9999 ($270F)
  SEC                                   ; $C291: 38
  SBC #$10                              ; $C292: E9 10
...
@StatAClampDone:
  LDA $048E                             ; $C2A5: AD 8E 04  ; report the delta
  ...
  LDA #$08                              ; $C2B6: A9 08
  STA $0501                             ; $C2B8: 8D 01 05  ; continue in state 8
...
State2_GrowStatB:
  ...
  LDA #$00                              ; $C2DF: A9 00
  STA $0501                             ; $C2E1: 8D 01 05  ; restart at state 0
  LDA #$00                              ; $C2E4: A9 00
  STA $0424                             ; $C2E6: 8D 24 04
  STA $0425                             ; $C2E9: 8D 25 04
  LDA #$A8                              ; $C2EC: A9 A8     ; UI mode $A8
  JMP B1F_SetUI2                        ; $C2EE: 4C 83 F2
@Wait:
  RTS                                   ; $C2F1: 60
@ApplyDrain:
  LDA $048E                             ; $C2F2: AD 8E 04  ; delta pair
...
@ScaleDown:
  ...
  LDA #$00                              ; $C356: A9 00
  STA $0522,X                           ; $C358: 9D 22 05  ; clamp at 0
@StatAClampDone:
  STA $0523,X                           ; $C35B: 9D 23 05
  LDA $0526,X                           ; $C35E: BD 26 05  ; stat B += scaled
  CLC                                   ; $C361: 18
  ...
  LDA $0526,X                           ; $C371: BD 26 05  ; clamp at 9999 ($270F)
  SEC                                   ; $C374: 38
  SBC #$10                              ; $C375: E9 10
...
@StatBClampDone:
  LDA #$08                              ; $C388: A9 08
  STA $0501                             ; $C38A: 8D 01 05  ; continue in state 8
...
@Wait:
  RTS                                   ; $C3A1: 60
@ReadRecords:
  LDY $0509                             ; $C3A2: AC 09 05  ; officer slot
  LDA $0664,Y                           ; $C3A5: B9 64 06  ; slot -> officer id
  ...
  LDA #$08                              ; $C3C4: A9 08
  STA $0501                             ; $C3C6: 8D 01 05  ; unchanged -> state 8
...
@StatChanged:
  ...
  INC $0501                             ; $C3E1: EE 01 05  ; continue in state 4
...
@ResetCommand:
  LDA #$00                              ; $C423: A9 00
  STA $0500                             ; $C425: 8D 00 05  ; clear command id
  STA $0501                             ; $C428: 8D 01 05  ; back to phase 0
@Wait:
  RTS                                   ; $C42B: 60
@ApplyRestore:
  ...
  LDA $0527,X                           ; $C434: BD 27 05  ; stat B high byte
  BNE @Deduct50                         ; $C437: D0 11
  LDA $0526,X                           ; $C439: BD 26 05  ; stat B low byte
  CMP #$32                              ; $C43C: C9 32     ; < 50 -> not enough
  BCS @Deduct50                         ; $C43E: B0 0A
  LDA #$08                              ; $C440: A9 08
  STA $0501                             ; $C442: 8D 01 05  ; state 8
  LDA #$B0                              ; $C445: A9 B0     ; UI mode $B0
  JMP B1F_SetUI2                        ; $C447: 4C 83 F2
@Deduct50:
  LDA $0526,X                           ; $C44A: BD 26 05  ; stat B -= 50
  SEC                                   ; $C44D: 38
  SBC #$32                              ; $C44E: E9 32
...
@RollGain:
  ...
  STA $042C                             ; $C465: 8D 2C 04  ; reported gain
  LDY $0509                             ; $C468: AC 09 05  ; officer slot
  LDA $0664,Y                           ; $C46B: B9 64 06  ; slot -> officer id
  ...
  CLC                                   ; $C483: 18
  ADC $042C                             ; $C484: 6D 2C 04  ; current += gain
  STA ($00),Y                           ; $C487: 91 00
  SEC                                   ; $C489: 38
...
@Finish:
  LDA #$08                              ; $C4A1: A9 08
  STA $0501                             ; $C4A3: 8D 01 05  ; continue in state 8
...
State5_SetupFormation:
  ...
  LDA #$00                              ; $C4ED: A9 00
  STA $0500                             ; $C4EF: 8D 00 05  ; clear command id
  STA $0501                             ; $C4F2: 8D 01 05  ; back to phase 0
@Wait:
  RTS                                   ; $C4F5: 60
@ExpandSlots:
  LDY $050E                             ; $C4F6: AC 0E 05  ; action index
  ...
  INC $0501                             ; $C502: EE 01 05  ; continue in state 6
  LDA #$00                              ; $C505: A9 00
...
@FirstSlot:
  ...
  LDA $044C,Y                           ; $C560: B9 4C 04  ; tile cell for slot
...
@NextSlot:
  ...
  LDA $044C,Y                           ; $C582: B9 4C 04  ; tile cell for slot
...
@SlotsDone:
  ...
  INC $0501                             ; $C61A: EE 01 05  ; continue in state 7
  RTS                                   ; $C61D: 60
...
State7_ApplyTileEffect:
  ...
  LDA #$05                              ; $C668: A9 05
  STA $0501                             ; $C66A: 8D 01 05  ; back to state 5
  LDA #$00                              ; $C66D: A9 00
...
@ApplySelectedTile:
  ...
  STA $044C                             ; $C681: 8D 4C 04  ; selected tile cell
  LDA $0012                             ; $C684: AD 12 00
  ASL                                   ; $C687: 0A        ; *3 (slot record stride)
  CLC                                   ; $C688: 18
  ADC $0012                             ; $C689: 6D 12 00
  TAY                                   ; $C68C: A8
  LDA $042C,Y                           ; $C68D: B9 2C 04  ; target offset low
  STA $0010                             ; $C690: 8D 10 00
  INY                                   ; $C693: C8
  LDA $042C,Y                           ; $C694: B9 2C 04  ; target offset high
  STA $0011                             ; $C697: 8D 11 00
  JSR GetBattleSideOffset               ; $C69A: 20 3E C9  ; X = side * 2
  LDA $0526,X                           ; $C69D: BD 26 05  ; compare stat B with target
  SEC                                   ; $C6A0: 38
  ...
  INC $0501                             ; $C6B1: EE 01 05  ; state 8
...
@CheckSpecial:
  ...
  LDA #$08                              ; $C6BE: A9 08
  STA $0501                             ; $C6C0: 8D 01 05  ; C=0: special handled, state 8
  RTS                                   ; $C6C3: 60
@ApplyTileBits:
  LDA #$0C                              ; $C6C4: A9 0C
  STA $00BD                             ; $C6C6: 8D BD 00
  LDA $0010                             ; $C6C9: AD 10 00
  STA $042C                             ; $C6CC: 8D 2C 04  ; report target offset
...
@WriteRecord:
  ...
  LDA #$08                              ; $C71E: A9 08
  STA $0501                             ; $C720: 8D 01 05  ; continue in state 8
...
;-------------------------------------------------------------------------------
CheckSpecialTiles:
  LDY $0509                             ; $C73B: AC 09 05  ; officer slot
  LDA $0664,Y                           ; $C73E: B9 64 06  ; slot -> officer id
  STA $0002                             ; $C741: 8D 02 00
  JSR B1F_GetOfficerRecordAddr          ; $C744: 20 D7 F2  ; runtime record -> ($00)
  LDA $044C                             ; $C747: AD 4C 04  ; current tile cell
  CMP #$0F                              ; $C74A: C9 0F
...
State8_WaitForNextCommand:
  ...
  LDA #$00                              ; $C7BF: A9 00
  STA $0500                             ; $C7C1: 8D 00 05  ; clear command id
  STA $0501                             ; $C7C4: 8D 01 05  ; restart at state 0
@Wait:
  RTS                                   ; $C7C7: 60
;-------------------------------------------------------------------------------
...
@ResetCommand:
  LDA #$00                              ; $C802: A9 00
  STA $0500                             ; $C804: 8D 00 05  ; clear command id
  STA $0501                             ; $C807: 8D 01 05  ; back to phase 0
@Wait:
  RTS                                   ; $C80A: 60
@Route:
  ...
  LDA $0470                             ; $C818: AD 70 04  ; route mode
  BNE @CheckMode1                       ; $C81B: D0 0A
  LDA #$00                              ; $C81D: A9 00
  STA $0501                             ; $C81F: 8D 01 05  ; mode 0 -> state 0
...
@CheckMode1:
  ...
  LDA #$05                              ; $C82B: A9 05
  STA $0501                             ; $C82D: 8D 01 05  ; mode 1 -> state 5
  LDA #$8C                              ; $C830: A9 8C
...
@RouteToState3:
  LDA #$03                              ; $C83A: A9 03
  STA $0501                             ; $C83C: 8D 01 05  ; other -> state 3
...
@SlotLoop:
  ...
  LDA #$00                              ; $C88D: A9 00
  STA $042E,X                           ; $C88F: 9D 2E 04  ; record byte 2 = 0
...
GetBattleSideOffset:
  ...
  LDA $0504                             ; $C940: AD 04 05  ; side flag
  BPL @Done                             ; $C943: 10 02
