...
AdjustSwapPositions:
  ...
  JSR Proc_B955                                       ; $B7D1: 20 55 B9  ; find matching slot index
...
@Phase2_AddToTarget:
  ...
  JSR Proc_B955                                       ; $B806: 20 55 B9  ; find matching slot index
